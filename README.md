...
<table align="center">
  <tr>
    <td width="60%">
      <h2>👨‍💻 About Me</h2>
      <p>I am a <strong>Full-Stack AI Engineer</strong> passionate about developing intelligent, scalable, production-grade applications that fuse modern software engineering with advanced artificial intelligence.</p>
      <ul>
        <li>🔭 Currently working as <strong>Junior AI Engineer</strong> at <strong>Octdaily</strong></li>
        <li>🧠 Specializing in <strong>Machine Learning</strong>, <strong>Deep Learning</strong>, <strong>Computer Vision</strong>, <strong>Generative AI</strong>, <strong>LLMs</strong>, <strong>RAG</strong> & <strong>Agentic Systems (LangGraph/MCP)</strong></li>
        <li>💻 Strong expertise in <strong>ASP.NET Core</strong>, <strong>C#</strong>, <strong>Python</strong>, <strong>Angular</strong>, <strong>FastAPI</strong>, and <strong>SQL/NoSQL Databases</strong></li>
        <li>🏆 <strong>1st Place Winner @ WebKode Hackathon</strong> & Former <strong>Web Dev Domain Head @ SENTEC NED</strong></li>
        <li>💬 Ask me about: <strong>AI Agents, RAG Pipelines, Computer Vision, Full-Stack Architecture & MCP</strong></li>
      </ul>
    </td>
    <td width="40%" align="center">
      <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&pause=1000&color=10B981&center=true&vCenter=true&width=320&lines=Full-Stack+AI+Engineer;Machine+%26+Deep+Learning;GenAI+%26+LLM+Agents;ASP.NET+Core+%26+Angular" width="320" alt="Typing Animation" />
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <p>
    <strong>Junior AI Engineer @ Octdaily</strong> <i>(Jan 2026 – Present)</i><br>
    Designing & deploying production AI applications using Machine Learning, Deep Learning, Computer Vision, LLMs, RAG, AI Agents (LangGraph), and Model Context Protocol (MCP).
  </p>
  <p>
    <strong>Trainee Software Engineer @ Octdaily</strong> <i>(Nov 2023 – Jan 2026)</i><br>
    Built enterprise web applications, REST APIs, and backend services using ASP.NET Core, C#, Angular, and SQL Server.
  </p>
  <p>
    <strong>Software Engineer @ Causeway Malaysia</strong> <i>(Jan 2023 – Nov 2023)</i><br>
    Managed web booking systems, digital infrastructure, API integrations, and scalable web platforms.
  </p>
  <p>
    <strong>Intern Software Engineer @ Purple Software</strong> <i>(Sep 2022 – Dec 2022)</i><br>
    Full-stack web development using Angular, Node.js, Payload CMS, and MongoDB.
  </p>
</div>
...
<!-- Tech Stack & Tools -->
<div align="center">
  <h2>🛠️ Tech Stack & Capabilities</h2>
  <br>
